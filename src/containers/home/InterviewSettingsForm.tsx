...
const InterviewDetailsForm: React.FC<{
  ...
  setPreviewData: (data: Partial<IInterViewSettings>) => void; // New prop
}> = ({ handleTab, setPreviewData }) => {
  const {
    errors,
    touched,
    handleSubmit,
      ...
      <Box width="100%">
        <FormSelect
          ...
          onChange={(value) => {
            ...
            setPreviewData({ interviewMode: value }); // Update preview data
          }}
        ...
        <FormSelect
          ...
          onChange={(value) => {
            ...
            setPreviewData({ interviewDuration: value }); // Update preview data
          }}
        ...
        <FormSelect
          ...
          onChange={(value) => {
            ...
            setPreviewData({ interviewLanguage: value }); // Update preview data
          }}
